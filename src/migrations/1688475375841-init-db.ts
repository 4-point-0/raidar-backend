...
export class InitDb1688475375841 implements MigrationInterface {
  name = 'InitDb1688475375841';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TYPE "public"."user_roles_enum" AS ENUM('user', 'artist')`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."user_provider_enum" AS ENUM('google')`,
    );
    await queryRunner.query(
      `CREATE TABLE "user" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "email" character varying(255) NOT NULL, "first_name" character varying(255), "last_name" character varying(255), "roles" "public"."user_roles_enum" array NOT NULL DEFAULT '{user}', "provider" "public"."user_provider_enum" DEFAULT 'google', "provider_id" character varying(255), "wallet_address" character varying(512), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_5e3a2b86fd9a9c22c266ae04731" UNIQUE ("provider_id"), CONSTRAINT "UQ_ac2af862c8540eccb210b293107" UNIQUE ("wallet_address"), CONSTRAINT "PK_cace4a159ff9f2512dd42373760" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "song" ADD CONSTRAINT "fkey_constraint_name" FOREIGN KEY ("user_id") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "song" ADD CONSTRAINT "album_id_fkey" FOREIGN KEY ("album_id") REFERENCES "album"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "song" ADD CONSTRAINT "music_id_fkey" FOREIGN KEY ("music_id") REFERENCES "file"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "song" ADD CONSTRAINT "art_id_fkey" FOREIGN KEY ("art_id") REFERENCES "file"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "listing" ADD CONSTRAINT "song_id_fkey" FOREIGN KEY ("song_id") REFERENCES "song"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "listing" ADD CONSTRAINT "seller_id_fkey" FOREIGN KEY ("seller_id") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "listing" ADD CONSTRAINT "buyer_id_fkey" FOREIGN KEY ("buyer_id") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "listing" DROP CONSTRAINT "buyer_id_fkey"`,
    );
    await queryRunner.query(
      `ALTER TABLE "listing" DROP CONSTRAINT "seller_id_fkey"`,
    );
    await queryRunner.query(
      `ALTER TABLE "listing" DROP CONSTRAINT "song_id_fkey"`,
    );
    await queryRunner.query(`ALTER TABLE "song" DROP CONSTRAINT "art_id_fkey"`);
    await queryRunner.query(
      `ALTER TABLE "song" DROP CONSTRAINT "music_id_fkey"`,
    );
    await queryRunner.query(
      `ALTER TABLE "song" DROP CONSTRAINT "album_id_fkey"`,
    );
    await queryRunner.query(
      `ALTER TABLE "song" DROP CONSTRAINT "fkey_constraint_name"`,
    );
    await queryRunner.query(
